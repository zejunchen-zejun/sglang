...
class ATOMForCausalLM(nn.Module):
    ...
    def __init__(
        ...
        print('[zejun] sglang ATOMForCausalLM __init__', flush=True)
    ...
    def forward(
        ...
        print('[zejun] sglang ATOMForCausalLM forward', flush=True)
    ...
    def load_weights(self, weights: Iterable[Tuple[str, torch.Tensor]]):
        # not yield from weights interable
        print('[zejun] sglang ATOMForCausalLM base load_weights', flush=True)
        # print('[zejun] vllm ATOMForCausalLM base load_weights, passed weights:', flush=True)
