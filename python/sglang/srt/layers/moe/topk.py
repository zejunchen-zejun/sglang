...
class TopK(CustomOp):
    ...
    def __init__(
        ...
        *,
        ...
        print("self.topk_config:", self.topk_config)
...
def select_experts(
    ...
    *,
    ...
    if num_fused_shared_experts > 0:
        ...
        # print("topk_weights after:", topk_weights)
        # print("fused_shared_experts_scaling_factor:", fused_shared_experts_scaling_factor)
        # print("num_fused_shared_experts:", num_fused_shared_experts)
        # print("topk_weights.size(0):", topk_weights.size(0))
        # print("torch.full:", torch.full((topk_weights.size(0), num_fused_shared_experts),scale_factor,dtype=topk_weights.dtype,device=topk_weights.device))
